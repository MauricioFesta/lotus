...
* @returns {Promise<any>}
*/
export function get_vagas(token: string, pagged_end: number, pagged: number): Promise<any>;
/**
* @param {string} token
* @returns {Promise<any>}
*/
...
* @returns {Promise<any>}
*/
export function get_vagas_empresa(token: string, pagged_end: number, pagged: number): Promise<any>;
/**
* @param {string} token
* @param {number} pagged_end
* @param {number} pagged
* @returns {Promise<any>}
*/
export function get_vagas_empresa_fechado(token: string, pagged_end: number, pagged: number): Promise<any>;
/**
* @param {string} token
* @returns {Promise<any>}
*/
...
export interface InitOutput {
  ...
  readonly get_vagas_empresa: (a: number, b: number, c: number, d: number) => number;
  readonly get_vagas_empresa_fechado: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly list_candidatos_vagas: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1392e9c959a3b010: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h87b55fb2e571761d: (a: number, b: number, c: number, d: number) => void;
}
