...
class CadastroNotPDF extends React.Component {
    ...
    constructor(props) {
        ...
        this.curriculoForm = {
            cidade: "", ensinomedio: "", filhos: "Não", casado: "Não",
            idade: "N/A", rua: "N/A", cidade: "N/A", telefone: "N/A", telefone_fixo: "N/A",
            descricao: "N/A", fax: "N/A", nome: "N/A", cidade: "Bento Gonçalves", ensinomedio: "Não"
        }
    ...
    handleAddExperiencia() {
        ...
        if (this.obs.empresa == "" || this.obs.ano == "" || this.obs.cargo == "") return;
        this.obs.experiencia.push({ empresa: this.obs.empresa, ano: this.obs.ano, cargo: this.obs.cargo })
        this.obs.ano = ""
        this.obs.empresa = ""
        this.obs.cargo = ""
    }
    ...
    handleAddFormacao() {
        ...
        if (this.obs.curso == "" || this.obs.data == "" || this.obs.instituicao == "") return;
        this.obs.formacao.push({ curso: this.obs.curso, data: this.obs.data, instituicao: this.obs.instituicao })
        this.obs.data = ""
        this.obs.curso = ""
    ...
    handleGetFoto() {
        ...
        formData.append("telefone_fixo", this.curriculoForm.telefone_fixo ? this.curriculoForm.telefone_fixo.replace("(", "").replace(")", "").replace("-", "") : "");
        ...
        return (
            ...
            <>
                ...
                <Form.Group>
                    ...
                    <InputMask className="form-control" mask="99" onChange={(el) => this.curriculoForm.idade = el.target.value} />
                ...
                <Form.Group>
                    ...
                    <InputMask className="form-control" mask="(99)9999-9999" onChange={(el) => this.curriculoForm.telefone_fixo = el.target.value} />
                    <Form.Text className="text-muted">
                        forneça seu telefone para o cadastro
                    </Form.Text>
                </Form.Group>
                ...
                <Form.Group>
                    ...
                    <InputMask className="form-control" mask="+99-999-99999999" onChange={(el) => this.curriculoForm.fax = el.target.value} />
                    <Form.Text className="text-muted">
                ...
                <Form.Row>
                    ...
                    <Form.Group>
                        <Form.Check
                            ...
                            id="filhos"
                            label="Filhos ?"
                            onChange={() => this.curriculoForm.filhos = $("#filhos").prop("checked").toString() === true ? "Sim" : "Não"}
                        />
                    </Form.Group>
                    ...
                    <Form.Group>
                        <Form.Check
                            ...
                            id="casado"
                            label="Casado ?"
                            onChange={() => this.curriculoForm.casado = $("#casado").prop("checked").toString() === true ? "Sim" : "Não"}
                        />
                    </Form.Group>
                ...
                <Form.Group>
                    ...
                    <Form.Row className="mb-4">
                        <Form.Group >
                            ...
                            <Form.Control style={{ width: 300 }} value={this.obs.empresa} id="empresa" type="titulo" onChange={(el) => this.obs.empresa = el.target.value} placeholder="empresa" />
                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group >

                            <Form.Control style={{ width: 450 }} value={this.obs.cargo} id="cargo" type="titulo" onChange={(el) => this.obs.cargo = el.target.value} placeholder="cargo" />
                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group >
                            <InputMask value={this.obs.ano} className="form-control" mask="9999" onChange={(el) => this.obs.ano = el.target.value} placeholder="ano saída" />
                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group>
                            <Button className="mb-2" intent="success" onClick={() => this.handleAddExperiencia()} text="+" />
                    ...
                    <ListGroup variant="flush">
                        {
                            this.obs.experiencia.map((el, index) => {
                                ...
                                return <ListGroup.Item id={index + Math.random}>{el.empresa + " " + el.ano}</ListGroup.Item>
                ...
                <Form.Group>
                    ...
                    <Form.Row className="mb-4">
                        <Form.Group >
                            ...
                            <Form.Control style={{ width: 300 }} value={this.obs.curso} id="curso" type="titulo" onChange={(el) => this.obs.curso = el.target.value} placeholder="curso" />
                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group >

                            <Form.Control style={{ width: 450 }} value={this.obs.instituicao} id="instituicao" type="titulo" onChange={(el) => this.obs.instituicao = el.target.value} placeholder="Instituição" />
                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group >
                            <InputMask value={this.obs.data} className="form-control" mask="9999" onChange={(el) => this.obs.data = el.target.value} placeholder="ano término" />

                        </Form.Group>
                        &nbsp;&nbsp;
                        <Form.Group>
                            <Button className="mb-2" intent="success" onClick={() => this.handleAddFormacao()} text="+" />
                    ...
                    <ListGroup variant="flush">
                        {
                            this.obs.formacao.map((el, index) => {
                                ...
                                return <ListGroup.Item id={index + Math.random}>{el.curso + " " + el.data}</ListGroup.Item>
